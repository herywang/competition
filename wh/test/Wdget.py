...
class Ui_ChooseDirection(QWidget):
    ...
    def setupUi(self, ChooseDirection):
        ChooseDirection.setObjectName("ChooseDirection")
        ChooseDirection.resize(454, 193)

        self.verticalLayoutWidget = QtWidgets.QWidget(ChooseDirection)
